...
if [ -f "$ROOT_DIR/docs/plans/in_progress/0087-public-api-polish-and-review-fixes.md" ] || [ -f "$ROOT_DIR/docs/plans/completed/0087-public-api-polish-and-review-fixes.md" ]; then
    ...
    check_cmd "cd '$ROOT_DIR' && rg -n 'lmt_svg_clock_optc|lmt_svg_optic_k_group|lmt_svg_evenness_chart|lmt_svg_fret\\b|lmt_svg_fret_n|lmt_svg_chord_staff|lmt_svg_key_staff|lmt_svg_keyboard' examples/wasm-demo/index.html examples/wasm-demo/app.js examples/wasm-demo/qa-atlas.js >/dev/null" "0087 qa atlas guardrail (all public docs image methods are rendered and atlas-covered)"
    check_cmd "cd '$ROOT_DIR' && rg -n 'lmt_bitmap_clock_optc_rgba|lmt_bitmap_optic_k_group_rgba|lmt_bitmap_evenness_chart_rgba|lmt_bitmap_fret_rgba|lmt_bitmap_fret_n_rgba|lmt_bitmap_chord_staff_rgba|lmt_bitmap_key_staff_rgba|lmt_bitmap_keyboard_rgba' include/libmusictheory.h build.zig scripts/check_wasm_exports.mjs examples/wasm-demo/qa-atlas.js >/dev/null" "0087 qa atlas guardrail (public bitmap image APIs are declared, exported, and atlas-consumed)"
    ...
    check_cmd "cd '$ROOT_DIR' && rg -n 'lmt_svg_evenness_chart|set-evenness|setEvennessSvg|setEvennessFeatures|ringCount|dotCount' examples/wasm-gallery/index.html examples/wasm-gallery/gallery.js scripts/lib/wasm_gallery_playwright_common.mjs scripts/validate_wasm_gallery_playwright.mjs README.md >/dev/null" "0087 public evenness guardrail (gallery and validation require a visible evenness chart example)"
    check_cmd "cd '$ROOT_DIR' && rg -n 'lmt_svg_optic_k_group|set-optic-k|setOpticKSvg|setOpticKFeatures|clockCount|linkCount' examples/wasm-gallery/index.html examples/wasm-gallery/gallery.js scripts/lib/wasm_gallery_playwright_common.mjs scripts/validate_wasm_gallery_playwright.mjs README.md >/dev/null" "0087 public OPTIC/K guardrail (gallery and validation require a visible OPTIC/K group diagram)"
