...
- Draft: 0001
- In progress: contrapunk-theory-integration, 0116-ordered-scale-and-mode-expansion-foundation
...
- `0116-ordered-scale-and-mode-expansion-foundation` — add the ordered parent-pattern layer, correct rooted mode derivation, extend the named mode inventory from 17 to 29, and expose honest public mode discovery helpers for the expanded C ABI surface.
