...
- `81e89d6` (2026-04-06):
  - Shipped behavior: added ordered-scale degree lookup, diatonic transposition, nearest lower/higher in-scale note helpers, and explicit snap tie-policy handling in Zig plus experimental C ABI exports `lmt_scale_degree`, `lmt_transpose_diatonic`, `lmt_nearest_scale_tones`, and `lmt_snap_to_scale`.
